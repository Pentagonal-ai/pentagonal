    ...
    <div className="login-page">
      <div className="login-card">
        ...
        <div className="oauth-buttons">
          <button className="oauth-btn google" onClick={() => handleOAuthSignIn('google')} disabled={loading}>
          ...
          <button className="oauth-btn github" onClick={() => handleOAuthSignIn('github')} disabled={loading}>
          ...
          <button className="oauth-btn twitter" onClick={() => handleOAuthSignIn('twitter')} disabled={loading}>
